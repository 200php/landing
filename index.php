...
<body class="homepage-6">
                    ...
                    <div class="col-12 col-md-10 col-lg-9">
                        <div class="download-text text-center wow bounceIn">
							...
							<div class="border-white">
								...
								<p class="text-white my-3">При заказе веников для бани,</p>
								<p class="text-white my-3">мы сделаем подарок для Вас:</p>
								<h3 class="my-4 text-yellow">Каждый 10-й веник в подарок!</h3>
							</div>
                        </div>
						<div class="text-center wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="subscribe-content text-center">
                            ...
                            <form id="feedback" action="" name="feedback" class="subscribe-form" method="post">
								...
								<div class="text-left agree">
									...
									<span>Согласен с <a href="/privacy.php" title="Политика конфиденциальности">политикой конфиденциальности</a></span>
								</div>
								<div class="text-left">
									<p id="show-click-footer" class="open-order-list" onclick="
										document.getElementById('order-list-footer').className = 'order-list block';
										document.getElementById('show-click-footer').className = 'open-order-list d-none';
										document.getElementById('hide-click-footer').className = 'close-order-list block'">
										Указать какие веники Вас заинтересовали
									</p>
								</div>
								
								<div class="text-left">
									<p id="hide-click-footer" class="close-order-list d-none" onclick="
										document.getElementById('order-list-footer').className = 'order-list d-none';
										document.getElementById('hide-click-footer').className = 'close-order-list d-none';
										document.getElementById('show-click-footer').className = 'open-order-list block'">
										Скрыть выбор веников
									</p>
								</div>
								
								<div id="order-list-footer" class="order-list d-none">
									<div class="paragraph">
										<input class="selection-name" type="checkbox" name="brooms[]" value="Берёзовый веник" />Берёзовый веник
										<span class="quantity d-none">
											<button class="decrease" type="button">-</button>
											<input class="q" type="text" name="q[]" value="0" maxlength="3" >
											<button class="increase" type="button">+</button>
										</span>
									</div>
									<div class="paragraph">
										<input class="selection-name" type="checkbox" name="brooms[]" value="Дубовый веник" />Дубовый веник
										<span class="quantity d-none">
											<button class="decrease" type="button">-</button>
											<input class="q" type="text" name="q[]" value="0" maxlength="3" >
											<button class="increase" type="button">+</button>
									...
									<div class="paragraph">
										<input class="selection-name" type="checkbox" name="brooms[]" value="Пихтовый веник" />Пихтовый веник
										<span class="quantity d-none">
											<button class="decrease" type="button">-</button>
											<input class="q" type="text" name="q[]" value="0" maxlength="3" >
											<button class="increase" type="button">+</button>
									...
									<div class="paragraph">
										<input class="selection-name" type="checkbox" name="brooms[]" value="Липовый веник" />Липовый веник
										<span class="quantity d-none">
											<button class="decrease" type="button">-</button>
											<input class="q" type="text" name="q[]" value="0" maxlength="3" >
											<button class="increase" type="button">+</button>
									...
									<div class="paragraph">
										<input class="selection-name" type="checkbox" name="brooms[]" value="Можжевеловый веник" />Можжевеловый веник
										<span class="quantity d-none">
											<button class="decrease" type="button">-</button>
											<input class="q" type="text" name="q[]" value="0" maxlength="3" >
											<button class="increase" type="button">+</button>
									...
									<div class="paragraph">
										<input class="selection-name" type="checkbox" name="brooms[]" value="Дубовый экстра веник" />Дубовый экстра веник
										<span class="quantity d-none">
											<button class="decrease" type="button">-</button>
											<input class="q" type="text" name="q[]" value="0" maxlength="3" >
											<button class="increase" type="button">+</button>
									...
									<div class="paragraph">
										<input class="selection-name" type="checkbox" name="brooms[]" value="Берёзовый экстра веник" />Берёзовый экстра веник
										<span class="quantity d-none">
											<button class="decrease" type="button">-</button>
											<input class="q" type="text" name="q[]" value="0" maxlength="3" >
											<button class="increase" type="button">+</button>
									...
									<div class="paragraph">
										<input class="selection-name" type="checkbox" name="brooms[]" value="Кленовый веник" />Кленовый веник
										<span class="quantity d-none">
											<button class="decrease" type="button">-</button>
											<input class="q" type="text" name="q[]" value="0" maxlength="3" >
											<button class="increase" type="button">+</button>
									...
									<div class="paragraph">
										<input class="selection-name" type="checkbox" name="brooms[]" value="Рябиновый веник" />Рябиновый веник
										<span class="quantity d-none">
											<button class="decrease" type="button">-</button>
											<input class="q" type="text" name="q[]" value="0" maxlength="3" >
											<button class="increase" type="button">+</button>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<form id="order-form" name="order" action="" method="post">
				<div class="form-group">
				...
				<div>
					<p id="show-click" class="open-order-list" onclick="
						document.getElementById('order-list').className = 'order-list block';
						document.getElementById('show-click').className = 'open-order-list d-none';
						document.getElementById('hide-click').className = 'close-order-list block'">
						Указать какие веники Вас заинтересовали
					</p>
				</div>
				
				<div>
					<p id="hide-click" class="close-order-list d-none" onclick="
						document.getElementById('order-list').className = 'order-list d-none';
						document.getElementById('hide-click').className = 'close-order-list d-none';
						document.getElementById('show-click').className = 'open-order-list block'">
						Скрыть выбор веников
					</p>
				</div>
				
				<div id="order-list" class="order-list d-none">
					<div class="paragraph">
						<input class="selection-name" type="checkbox" name="brooms[]" value="Берёзовый веник" />
						<label>Берёзовый веник</label>
						<span class="quantity d-none">
							<button class="decrease" type="button">-</button>
							<input class="q" type="text" name="q[]" value="0" maxlength="3" >
							<button class="increase" type="button">+</button>
					...
					<div class="paragraph">
						<input class="selection-name" type="checkbox" name="brooms[]" value="Дубовый веник" />
						<label>Дубовый веник</label>
						<span class="quantity d-none">
							<button class="decrease" type="button">-</button>
							<input class="q" type="text" name="q[]" value="0" maxlength="3" >
							<button class="increase" type="button">+</button>
					...
					<div class="paragraph">
						<input class="selection-name" type="checkbox" name="brooms[]" value="Пихтовый веник" />
						<label>Пихтовый веник</label>
						<span class="quantity d-none">
							<button class="decrease" type="button">-</button>
							<input class="q" type="text" name="q[]" value="0" maxlength="3" >
							<button class="increase" type="button">+</button>
					...
					<div class="paragraph">
						<input class="selection-name" type="checkbox" name="brooms[]" value="Липовый веник" />
						<label>Липовый веник</label>
						<span class="quantity d-none">
							<button class="decrease" type="button">-</button>
							<input class="q" type="text" name="q[]" value="0" maxlength="3" >
							<button class="increase" type="button">+</button>
					...
					<div class="paragraph">
						<input class="selection-name" type="checkbox" name="brooms[]" value="Можжевеловый веник" />
						<label>Можжевеловый веник</label>
						<span class="quantity d-none">
							<button class="decrease" type="button">-</button>
							<input class="q" type="text" name="q[]" value="0" maxlength="3" >
							<button class="increase" type="button">+</button>
					...
					<div class="paragraph">
						<input class="selection-name" type="checkbox" name="brooms[]" value="Дубовый экстра веник" />
						<label>Дубовый экстра веник</label>
						<span class="quantity d-none">
							<button class="decrease" type="button">-</button>
							<input class="q" type="text" name="q[]" value="0" maxlength="3" >
							<button class="increase" type="button">+</button>
					...
					<div class="paragraph">
						<input class="selection-name" type="checkbox" name="brooms[]" value="Берёзовый экстра веник" />
						<label>Берёзовый экстра веник</label>
						<span class="quantity d-none">
							<button class="decrease" type="button">-</button>
							<input class="q" type="text" name="q[]" value="0" maxlength="3" >
							<button class="increase" type="button">+</button>
					...
					<div class="paragraph">
						<input class="selection-name" type="checkbox" name="brooms[]" value="Кленовый веник" />
						<label>Кленовый веник</label>
						<span class="quantity d-none">
							<button class="decrease" type="button">-</button>
							<input class="q" type="text" name="q[]" value="0" maxlength="3" >
							<button class="increase" type="button">+</button>
					...
					<div class="paragraph">
						<input class="selection-name" type="checkbox" name="brooms[]" value="Рябиновый веник" />
						<label>Рябиновый веник</label>
						<span class="quantity d-none">
							<button class="decrease" type="button">-</button>
							<input class="q" type="text" name="q[]" value="0" maxlength="3" >
							<button class="increase" type="button">+</button>
	...
	document.addEventListener('click', function (e) {
		...
		if (e.target.classList.contains("selection-name")) {
			var a = e.target.parentElement.querySelector("span");
			if (a.className == "quantity d-none") {
				a.className = "quantity block";
				a.querySelector("input.q").name = "q-new[]";
			}
			else {
				a.className = "quantity d-none";	
				a.querySelector("input.q").name = "q[]";				
			}
		}				
	});
	</script>
